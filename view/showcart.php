...
<form method="post" name="form">
  ...
  <tr bgcolor="#eee" align="center" height="30" style="font-weight:bold">
    <td width="50" style="border-right:1px solid #666"><font color="#000">STT</font></td>
    <td width="110" style="border-right:1px solid #666"><font color="#000">Sản phẩm</font></td>
    <td width="60" style="border-right:1px solid #666"><font color="#000">Số lượng</font></td>
    <td width="95" style="border-right:1px solid #666"><font color="#000">Giá</font></td>
    <td width="95" style="border-right:1px solid #666"><font color="#000">Tổng</font></td>
    <td width="50" ><font color="#000">Xóa</font></td>                
  </tr>
  <?php   
  	$user=$_SESSION["user"];	
...
?>			
 ...
 <?php			
  ...
  <tr>
    ...
    <input type=\"button\" name=\"tieptucmuahang\" value=\"Tiếp Tục Mua Hàng\"  onclick=\"document.form.action='index.php'; document.form.submit();\" />
    
    <input type=\"submit\" name=\"capnhatgiohang\" value=\"Cập Nhật\"  onclick=\"document.form.submit();\" />
    
	<input type=\"submit\" name=\"xoagiohang\" value=\"Xóa Giỏ Hàng\"  onclick=\"document.form.submit();\" />
    
	<input type=\"submit\" name=\"dathang\" value=\"Đặt Hàng\"  onclick=\"document.form.submit();\"/>
    </td>
  </tr>";  
    ?> 

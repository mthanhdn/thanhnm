...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="40"  padding-bottom:5px; font-weight:bold">
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>	
    <td style="padding-left:5px; width:550px; height:30px"><a href="?b=lsp&idl=<?php echo $id_loai; ?>" style="color: #000; font-size:14px; font-weight:bold"><?php echo $tenloaisp;?></a>
  </tr> 
  <tr>

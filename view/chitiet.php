...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="33" width="448" style="background-color:#444; padding-left:30px; color:#FFF; font-size:16px; font-weight:bold">THÔNG TIN SẢN PHẨM</td> 
  </tr>
</table>
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
...
thanh toán:</td>
    <td style="padding-left:5px"><p>Nhận tiền khi giao hàng</p></td>
  </tr>
...
<tr>
    ...
    <div id="TabbedPanels1" class="TabbedPanels">
        ...
        <li class="TabbedPanelsTab" tabindex="0"><font color="#000">Sản phẩm cùng loại</font></li>        
	    </ul>

...
<tr>
    <td colspan=6 style=\"background:#444;color:white;\"  align=center>GIỎ HÀNG CỦA QUÝ KHÁCH</td>
  </tr>
  <tr bgcolor=\"#444\" align=center height=30 style=\"color:white \">
...
if($count=="")
{
  ...
  echo "<tr>
	...
	<input type=\"button\" name=\"dathang\" value=\"Đặt Hàng\"  onclick=\"document.getElementById('thanhtoan').style.display='block'\"/>
	</form>
    </td>
  </tr>";  
}
	...
	<form id='k$id'>
      ...
      <tr>
		...
		<input type=\"button\" value=\"Gửi\"  onclick=\"subMitF('k$id', 'tt');\">

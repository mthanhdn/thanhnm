...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="40" style="border-bottom:1px solid #333; padding-bottom:5px; font-weight:bold">
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>	
    <td bgcolor="#444" style="padding-left:5px; width:550px; height:30px" ><a  style="color: #fff; font-size:13px; font-weight:bold"><?php echo $tenloaisp;?></a></td>
  </tr> 
  <tr>
...
//******************************** Nội Dung ***********************************************//
	...
	//	echo "$sql3<hr>";
		...
		while($r3=mysql_fetch_array($kq3))
		{
			...
			<table width=175 height=220 border=0 cellspacing=0 cellpadding=0  style=\"border:1px dotted #999\">
			  <tr>

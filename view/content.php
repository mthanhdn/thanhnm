<div><table width="560" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td height="40"  repeat-x; padding-bottom:5px; font-weight:bold"><font color="#FF0000">SẢN PHẨM MỚI </font><img src="images/new.gif" /></td>
  </tr>
</table>
<?php	
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>	
      <td style="padding-left:5px; width:550px; height:30px; background: #444; border: solid 1px #ccc"> <a href="?b=lsp&idl=<?php echo $id_loai; ?>" style="color: white; font-size:14px; font-weight:bold"><img src="images/new-icon.png" /><?php echo $tenloaisp;?></a></td>
  </tr> 
  <tr>

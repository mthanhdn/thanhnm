...
<?php			
  ...
  <tr>
    ...
    <input type=\"submit\" name=\"xoagiohang\" value=\"Xóa Giỏ Hàng\"  onclick=\"document.form.submit();\" /></td>
  </tr>";
   	?>
...
<?php			
  ...
  ?>  
  <tr>
  	<td colspan="5" align="center" style="background-color:#eee; color:#000;" height="35">
 <?php
    //*******************************Xuất số trang************************************
	if($numrow==0)

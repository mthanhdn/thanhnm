...
<table width="735" border="0" cellspacing="0" cellpadding="0">  
  <tr height="30" bgcolor="#eee">
    <td align="center" width="50" style="border-left:1px solid #333;border-right:1px solid #333"><strong><font color="#000">Chọn</font></strong></td>
    <td align="center" width="235" style="border-right:1px solid #333"><strong><font color="#000">Nhóm sản phẩm</font></strong></td>
    <td align="center" width="250" style="border-right:1px solid #333"><strong><font color="#000">Loại sản phẩm</font></strong></td>    
    <td align="center" width="100" style="border-right:1px solid #333"><strong><font color="#000">Sửa</font></strong></td>
    <td align="center" width="100"><strong><font color="#000">Xóa</font></strong></td>    
  </tr>  
<?php
		$idn=$_GET["idn"];
